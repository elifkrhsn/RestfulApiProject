...
public class EmployeeService {
    ...
    private final OtherInformationMapper otherInformationMapper;
    private final ProjectMapper projectMapper;


    @Autowired
    public EmployeeService(EmployeeRepository employeeRepository, EmployeeMapper employeeMapper, PersonalInformationMapper personalInformationMapper, OtherInformationMapper otherInformationMapper, ProjectMapper projectMapper) {
        this.employeeRepository = employeeRepository;
        this.employeeMapper = employeeMapper;
        this.personalInformationMapper = personalInformationMapper;
        this.otherInformationMapper = otherInformationMapper;
    ...
    //update operation implementation code
    @Transactional
